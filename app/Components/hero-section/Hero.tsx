...
export default function Hero(){
    return(
        <div className="flex flex-col w-full justify-around md:flex-row">
            <div className="flex flex-col w-full mt-4 md:p-4">
            <p className="font-extrabold text-4xl p-2">LETS EXPLORE</p>
            <span style={{ backgroundColor: '#EBD96B' }} className="font-extrabold text-4xl p-2 w-[60%] lg:w-[20%] md:w-[35%]">UNIQUE</span>
